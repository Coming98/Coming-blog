...
2. 执行命令创建数据模型: `python manage.py makemigrations polls`; 每当数据模型更改时即可更新存储的 migration

![](https://raw.githubusercontent.com/Coming98/pictures/main/202212071747082.png)

Tips: migration 就像是一种中间数据, 可以转换为多种数据库的语句, 例如迁移到 SQL: `python manage.py sqlmigrate polls 0001`
- Table names are automatically generated by combining the name of the app (polls) and the lowercase name of the model – question and choice. (You can override this behavior.)
- Primary keys (IDs) are added automatically. (You can override this, too.)
- 
![](https://raw.githubusercontent.com/Coming98/pictures/main/202212071749684.png)

3. 在数据库中创建模型和表: `python manage.py migrate`
